...
#+ 24 * 60 * 60 * 1000 * 10
    '''
    startDateString = "24/11/2020 08:00:00"
    premarketStartDateString = "24/11/2020 17:00:00"
    endDateString = "26/11/2020 22:00:00"
    ...
    resultsTable.to_excel(r'C:\Users\rohit kurup\Documents\PlayType-1Point1(2ndNovTo20thNov2020)(StocksFrom21stTo25thSept)TestX.xlsx', index=False, header=True)
