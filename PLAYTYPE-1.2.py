...
def bigloopType5(): # Type 1.0 plays
    ...
    # update all of these later
    premarketstart = 1601280000000  # 28th sept 4PM SGT,

    currentTime = 1601251200000  # 28th sept 8AM SGT
    endTime = 1603324800000 + 24 * 60 * 60 * 1000  # 23rd OCT 8AM SGT
#+ 24 * 60 * 60 * 1000 * 10
    stockIterator = 0
    ...
    while(currentTime < endTime):
        ...
        print(' THIS IS WHAT THE PREMARKET  LOOKS LIKE: ', premarketFri)
        ...
        print('THIS IS THE MARKET AFTER CRACKING PM LOW: ', market_after_cracking_pmlow)
    ...
    resultsTable.to_excel(r'C:\Users\rohit kurup\Documents\PlayType-1Point2(28ThSeptTo22ndOct2020)(StocksFrom21stTo25thSept)Test2.xlsx', index=False, header=True)
